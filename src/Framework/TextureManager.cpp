...
///////////////////////////////////////////////////////////////
CTextureManager *CTextureManager::GetInstance() { return m_pInstance; }
///////////////////////////////////////////////////////////////
...
#pragma endregion
///////////////////////////////////////////////////////////////
CTextureManager::CTextureManager() { m_pTotalTextureMemory = 0; }
...
///////////////////////////////////////////////////////////////
uint CTextureManager::LoadTexture(const char *a_pTextureName) {
  CTexture *pTexture = nullptr;
  if (a_pTextureName != nullptr) {
    std::map<std::string, CTexture *>::iterator dictionaryIter =
        m_pTextureDictionary.find(a_pTextureName);
    if (dictionaryIter != m_pTextureDictionary.end()) {
      // We have found our Texture in the Dictionary return a reference to to it
      // and
...
///////////////////////////////////////////////////////////////
void CTextureManager::RemoveTexture(uint &a_uiTextureID) {
  std::map<std::string, CTexture *>::iterator dictionaryIter =
      m_pTextureDictionary.begin();
...
///////////////////////////////////////////////////////////////
void CTextureManager::IncrementTextureReference(uint a_uiTextureID) {
  std::map<std::string, CTexture *>::iterator dictionaryIter =
      m_pTextureDictionary.begin();
  for (; dictionaryIter != m_pTextureDictionary.end(); ++dictionaryIter) {
    CTexture *pTexture = static_cast<CTexture *>(dictionaryIter->second);
...
///////////////////////////////////////////////////////////////
void CTextureManager::DecrementTextureReference(uint a_uiTextureID) {
  std::map<std::string, CTexture *>::iterator dictionaryIter =
      m_pTextureDictionary.begin();
  for (; dictionaryIter != m_pTextureDictionary.end(); ++dictionaryIter) {
    CTexture *pTexture = static_cast<CTexture *>(dictionaryIter->second);
