...
#pragma endregion
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, iScreenWidth, iScreenHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, 0);
        ...
        m_ShaderID = NHTV::Utility::loadShaderFromFile(3, aszInputs, 2, aszOutputs, "../resources/shaders/default.vsh", "../resources/shaders/default.fsh");
...
#pragma region Post-processing rendering functionality
    void Application::SetPostProcessFx(const char* a_pShaderName)
    {
        ...
        m_postFxShader = NHTV::Utility::loadShaderFromFile(1, pfxInputs, 1, pfxOutputs, "../resources/shaders/fullpass.vsh", a_pShaderName);
        m_postProcess = true;
    }
#pragma endregion
