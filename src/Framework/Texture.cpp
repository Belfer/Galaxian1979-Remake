...
///////////////////////////////////////////////////////////////
uint CTexture::Load(const char *filename) {
  uint uiTextureID = -1;
  if (filename != nullptr) {
    ...
    uiTextureID = NHTV::Utility::loadTexture(m_pFilename, m_iWidth, m_iHeight,
                                             m_iBitsPerPixel);
...
///////////////////////////////////////////////////////////////
void CTexture::GetTextureSize(uint &iWidth, uint &iHeight) {
  iWidth = m_iWidth;
  iHeight = m_iHeight;
}
///////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
void CTexture::IncrememntRefCount() { ++m_iRefCount; }
///////////////////////////////////////////////////////////////
//
///////////////////////////////////////////////////////////////
void CTexture::DecrementRefCount() { --m_iRefCount; }
///////////////////////////////////////////////////////////////
// Get the size of this texture in memory
///////////////////////////////////////////////////////////////
uint CTexture::GetTextureSizeInMemory() { return m_iTextureMemory; }
